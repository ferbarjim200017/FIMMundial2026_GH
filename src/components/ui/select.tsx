...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      collisionPadding={8}
      className={cn(
        // max-w al viewport: en móvil, con opciones largas (p. ej. partidos), el
        // desplegable se salía por la derecha y no se podía ver entero.
        "relative z-50 max-h-96 min-w-[8rem] max-w-[calc(100vw-1rem)] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md",
        position === "popper" &&
