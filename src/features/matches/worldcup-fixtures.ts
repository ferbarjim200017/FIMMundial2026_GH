...
export const WORLDCUP_2026_MATCHES: SeedMatch[] = [
  ...
  // Cruces oficiales ya resueltos tras la fase de grupos.
  km(73, "r32", "2026-06-28T19:00:00Z", "Sudáfrica", "Canadá", "SoFi Stadium", "Inglewood"),
  km(76, "r32", "2026-06-29T17:00:00Z", "Brasil", "Japón", "NRG Stadium", "Houston"),
  km(74, "r32", "2026-06-29T20:30:00Z", "Alemania", "Paraguay", "Gillette Stadium", "Foxborough"),
  km(75, "r32", "2026-06-30T01:00:00Z", "Países Bajos", "Marruecos", "Estadio BBVA", "Guadalupe"),
  km(78, "r32", "2026-06-30T17:00:00Z", "Costa de Marfil", "Noruega", "AT&T Stadium", "Arlington"),
  km(77, "r32", "2026-06-30T21:00:00Z", "Francia", "Suecia", "MetLife Stadium", "East Rutherford"),
  km(79, "r32", "2026-07-01T01:00:00Z", "México", "Ecuador", "Estadio Azteca", "Ciudad de México"),
  km(80, "r32", "2026-07-01T16:00:00Z", "Inglaterra", "RD del Congo", "Mercedes-Benz Stadium", "Atlanta"),
  km(82, "r32", "2026-07-01T20:00:00Z", "Bélgica", "Senegal", "Lumen Field", "Seattle"),
  km(81, "r32", "2026-07-02T00:00:00Z", "Estados Unidos", "Bosnia y Herzegovina", "Levi's Stadium", "Santa Clara"),
  km(84, "r32", "2026-07-02T19:00:00Z", "España", "Austria", "SoFi Stadium", "Inglewood"),
  km(83, "r32", "2026-07-02T23:00:00Z", "Portugal", "Croacia", "BMO Field", "Toronto"),
  km(85, "r32", "2026-07-03T03:00:00Z", "Suiza", "Argelia", "BC Place", "Vancouver"),
  km(88, "r32", "2026-07-03T18:00:00Z", "Australia", "Egipto", "AT&T Stadium", "Arlington"),
  km(86, "r32", "2026-07-03T22:00:00Z", "Argentina", "Cabo Verde", "Hard Rock Stadium", "Miami Gardens"),
  km(87, "r32", "2026-07-04T01:30:00Z", "Colombia", "Ghana", "Arrowhead Stadium", "Kansas City"),
